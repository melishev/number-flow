...
export declare function formatToData(value: Value, formatter: Intl.NumberFormat, prefix?: string, suffix?: string, transformParts?: (parts: Intl.NumberFormatPart[]) => Intl.NumberFormatPart[]): {
    pre: KeyedNumberPart[];
